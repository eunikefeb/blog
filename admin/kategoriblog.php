            ...
            <div class="card">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        window.location.href ='kategoriblog.php?aksi=hapus&data=<?php echo $id_kategori_blog;?>&notif=hapusberhasil'" 
              ...
              <?php
                ...
                if (isset($_GET["katakunci"])){
                  $katakunci_kategori = $_GET["katakunci"];
                  if($halaman!=1){
                    echo "<i class='page-item'>
                    <a class='page-link'='kategoriblog.php?katakunci=$katakunci_kategori&halaman=1'>First</a></li>";
                    echo "<li class='page-item'>
                    <a class='page-link'href='kategoriblog.php?katakunci=$katakunci_kategori&halaman=$sebelum'>«</a></li>";
                  }
                  ...
                  if($halaman!=$jum_halaman){
                    echo "<li class='page-item'><a class='page-link'
                    href='kategoriblog.php?katakunci=$katakunci_kategori&halaman=$setelah'>
                    »</a></li>";
                    echo "<li class='page-item'><a class='page-link'
                    ...
                    if($halaman!=1){
                      echo "<li class='page-item'><a class='page-link'
                      href='kategoriblog.php?halaman=1'>
                      First</a></li>";
                      echo "<li class='page-item'><a class='page-link'
                      href='kategoriblog.php?halaman=$sebelum'>
                      «</a></li>";
                    }
                    for($i=1; $i<=$jum_halaman; $i++){
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                        if($i!=$halaman){
                          echo "<li class='page-item'><a class='page-link'
                          href='kategoriblog.php?halaman=$i'>
                          $i</a></li>";
                        }else{
                          echo "<li class='page-item'>
                          <a class='page-link'>$i</a></li>";
                    ...
                    if($halaman!=$jum_halaman){
                    echo "<li class='page-item'><a class='page-link'
                    href='kategoriblog.php?halaman=$setelah'>»</a></li>";
                    echo "<li class='page-item'><a class='page-link'
